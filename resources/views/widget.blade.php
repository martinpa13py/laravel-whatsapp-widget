...
@php
    $message = config('laravel-whatsapp-widget.message') . url()->current();
    $phone = config('laravel-whatsapp-widget.phonenumber');
@endphp

<div id="whatsapp_chat_widget">
    <a id="wa-widget-send-button" href="https://web.whatsapp.com/send?phone={{ $phone }}&text={{ $message }}" target="_blank">
